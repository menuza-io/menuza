		...
		<Screen className="bg-background">
			...
			>
				...
				<View className="flex-1">
					<View className="gap-5">
						<View className="gap-2">
							<Text className="text-foreground mb-1 text-base">Username</Text>
							<Controller
								control={control}
								name="username"
						...
						<View className="gap-2">
							<Text className="text-foreground mb-1 text-base">Full Name</Text>
							<Controller
								control={control}
								name="name"
								render={({ field: { onChange, onBlur, value } }) => (
						...
						<View className="gap-2">
							<Text className="text-foreground mb-1 text-base">Password</Text>
							<Controller
								control={control}
								name="password"
								render={({ field: { onChange, onBlur, value } }) => (
				...
				<View className="mt-auto items-center pt-8">
					...
					>
						<Text className="text-primary text-base">Back to verification</Text>
					</TouchableOpacity>
				</View>
			</ScrollView>
